...
Button2::Button2(uint8_t attachTo, uint8_t buttonMode /* = INPUT_PULLUP */, bool isCapacitive /* = false */, bool activeLow /* = true */) {
  begin(attachTo, buttonMode, isCapacitive, activeLow);
}

/////////////////////////////////////////////////////////////////

void Button2::begin(uint8_t attachTo, uint8_t buttonMode /* = INPUT_PULLUP */, bool isCapacitive /* = false */, bool activeLow /* = true */) {
  pin = attachTo;
  ...
  state = _getState();
  prev_state = state;
  FreeRTOS::startTask(Button2::run, "button 2 thread", this, 2048) ;
}
void Button2::run(void * arg )
{
  Button2 * _this = (Button2 * )arg;
  while (1)
  {
...
uint8_t Button2::getAttachPin() const {
  return pin;
}
...
uint8_t Button2::getClickType() const {
  return last_click_type;
}

/////////////////////////////////////////////////////////////////

uint8_t Button2::_getState() {
  uint8_t state = 0;
  if (!is_capacitive) {
