...
esp_err_t set_esp_interface_ip(esp_interface_t interface, IPAddress local_ip=_INADDR_NONE, IPAddress gateway=_INADDR_NONE, IPAddress subnet=_INADDR_NONE, IPAddress dhcp_lease_start=_INADDR_NONE);
